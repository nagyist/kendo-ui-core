---
title: Overview
page_title: DockManager Documentation | DockManager Accessibility
description: "Get started with the {{ site.product }} DockManager and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
components: ["dockmanager"]
slug: htmlhelpers_dockmanager_accessibility
position: 1
---

# DockManager Accessibility

Out of the box, the {{ site.product }} DockManager provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
