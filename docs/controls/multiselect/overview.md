...
description: "Explore the Kendo UI for jQuery MultiSelect with data binding, filtering, grouping, virtualization, templates, summary tags, and new-item support."
...
The MultiSelect displays a list of options and allows for multiple selections from that list. The component represents a richer version of the `<select>` element and provides support for local and remote data binding, filtering, item and tag templates, and configurable options for controlling the list behavior.
