...
[PromptBox accessibility specification]({% slug accessibility_kendoui_promptbox %})
...
A live test example of the Chat component could be found here: https://demos.telerik.com/kendo-ui/accessibility/chat
