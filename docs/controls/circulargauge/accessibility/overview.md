...
page_title: jQuery CircularGauge Documentation | CircularGauge Accessibility
description: "Get started with the jQuery CircularGauge by Kendo UI and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
components: ["circulargauge"]
slug: jquery_circulargauge_accessibility
position: 1
---

# CircularGauge Accessibility

The CircularGauge is accessible by screen readers and provides WAI-ARIA, Section 508, and WCAG 2.2 support.

For more information, refer to [Accessibility in Kendo UI for jQuery]({% slug overview_accessibility_support_kendoui %}).

Out of the box, the Kendo UI for jQuery CircularGauge provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
The CircularGauge has been tested with [axe-core](https://github.com/dequelabs/axe-core).

### Test Example

A live test example of the CircularGauge component could be found here: https://demos.telerik.com/kendo-ui/accessibility/circulargauge
