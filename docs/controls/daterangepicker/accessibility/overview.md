...
page_title: jQuery DateRangePicker Documentation | DateRangePicker Accessibility
description: "Get started with the jQuery DateRangePicker by Kendo UI and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
components: ["daterangepicker"]
slug: jquery_daterangepicker_accessibility
position: 1
---
...
* [Keyboard navigation by the Kendo UI DateRangePicker](https://demos.telerik.com/kendo-ui/daterangepicker/keyboard-navigation)
* [Accessibility in Kendo UI for jQuery]({% slug overview_accessibility_support_kendoui %})

Out of the box, the Kendo UI for jQuery DateRangePicker provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
[MultiViewCalendar accessibility specification]({% slug jquery_multiviewcalendar_accessibility %})
...
The DateRangePicker has been tested with [axe-core](https://github.com/dequelabs/axe-core).

### Test Example

A live test example of the DateRangePicker component could be found here: https://demos.telerik.com/kendo-ui/accessibility/daterangepicker
